...
// 和@Controller区别：RestController return json object（default), Controller return任何格式都可以，如model,view,string
...
public class UserController {
	...
	@PostMapping
	public Response addUser(@RequestBody User user) { //RequestBody：接收的参数是json
